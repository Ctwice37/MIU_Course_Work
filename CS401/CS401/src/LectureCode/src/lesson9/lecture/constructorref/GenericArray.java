package LectureCode.src.lesson9.lecture.constructorref;
...
public class GenericArray {
	public static void main(String[] args) {
		...
		//to correctly determine the size and type of the output array?
	...
	public static String[] myToArray(Stream<String> stream, IntFunction<String[]> f) {
		Object[] obArr = stream.toArray();  //yields the desired array length
		String[] retVal =  f.apply(obArr.length); //we now have array of right type and size
