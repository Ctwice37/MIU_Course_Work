package LectureCode.src.lesson8.lecture.lambdaexamples.runnable;
...
/**
 * This code shows illustrates how, in a lambda expression:
 * 1. local variables may not be mutated 
 * 2. instance variables are allowed to be mutated (but should *not* be mutated) 
 */
